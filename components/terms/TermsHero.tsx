  ...
  return (
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 bg-[#FAFAFA] overflow-hidden border-b border-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <FileText className="w-4 h-4 text-[#a40049]" />
        ...
        >
          Terms & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#a40049] to-[#ff4d94]">Conditions.</span>
        </motion.h1>
        ...
        >
          Welcome to SKD Event Management. By accessing our website, submitting a booking, or using our services, you agree to the following terms, governed by the laws of Sri Lanka.
        </motion.p>
